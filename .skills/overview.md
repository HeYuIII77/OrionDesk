...
| 启动器 | ✅ 完成 | 右键添加应用、图标显示、重命名、桌面图标智能隐藏、锁定 |
| 便签 | ✅ 完成 | 多颜色、防抖保存、锁定 |
| 文件夹映射 | ✅ 完成 | 树形结构、懒加载、搜索文件、拖入文件夹、右键设置路径、锁定 |
| 版本控制监控 | ✅ 完成 | Git/SVN 仓库扫描、同步状态、[Git]/[SVN] 标签、拖拽添加 |
| 快捷工具 | ✅ 完成 | 图标网格、预置工具、自定义添加、管理员权限启动 |
| 日历事项 | ✅ 完成 | 月视图、事项管理、重复事项、倒计时/正计时 |
| CMD 启动器 | ✅ 完成 | 大图标一键启动 CMD、多条命令支持、自定义图标/名称/命令/起始目录 |
| 桌面球 | ✅ 完成 | 悬浮小球、双击切换组件置顶/桌面层、边缘吸附、位置持久化 |
